...
deims_path = os.path.dirname(os.path.abspath(__file__)) + "\harvester\deims.py"
icos_path = os.path.dirname(os.path.abspath(__file__))  + "\harvester\icos.py"
nemsr_path = os.path.dirname(os.path.abspath(__file__)) + "\harvester\_nemsr.py"
